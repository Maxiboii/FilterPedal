...
struct PathProducer
{
    PathProducer(SingleChannelSampleFifo<FilterPedalAudioProcessor::BlockType>& scsf) :
...
private:
    SingleChannelSampleFifo<FilterPedalAudioProcessor::BlockType>* leftChannelFifo;
